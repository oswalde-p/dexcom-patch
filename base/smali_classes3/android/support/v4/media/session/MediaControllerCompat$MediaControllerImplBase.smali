...
.method private varargs ࡰ᫓ࡨ(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 58
    :try_start_0
    iget-object v1, v4, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplBase;->mBinder:Landroid/support/v4/media/session/IMediaSession;
    ...
    .line 59
    iget-object v0, v4, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplBase;->mBinder:Landroid/support/v4/media/session/IMediaSession;
    ...
    const-string v10, "WnlpgHsqvsokjbn>ifhXj"
    ...
    const-string v4, "76BC::=F{J?X\u007fOQW\u0004GK\u0007V^VW\u001a"
    ...
    invoke-interface {v1, v3, v2, v0}, Landroid/support/v4/media/session/IMediaSession;->setVolumeTo(IILjava/lang/String;)V
    ...
    const-string v5, "!86:1\u0012=;@=954,8\u0008302\"4"
    ...
    const-string v3, "q\u0014\u0011\u0015Q\"\u0016\u001f\u001b\u001a,X#)[0#3\u00160.81*\u001a6u"
    ...
    check-cast v9, Landroid/support/v4/media/MediaDescriptionCompat;
    ...
    invoke-interface {v0, v9}, Landroid/support/v4/media/session/IMediaSession;->removeQueueItem(Landroid/support/v4/media/MediaDescriptionCompat;)V
    ...
    const-string v2, "EZXc\u0015iXglcff\u001dbjaTP\u0006T\u0005YXTYYY\\\r_`QF7n=6D4;>G<FQ}JL&4 4.517"
    ...
    const-string v4, "TY+*t\u0001p|\u001d_^DPK3p\u001c^1<\u0010 2ZqE\u0016\u001a\tk\u0018"
    ...
    check-cast v5, Landroid/support/v4/media/session/MediaControllerCompat$Callback;
    ...
    iget-object v0, v5, Landroid/support/v4/media/session/MediaControllerCompat$Callback;->mCallbackObj:Ljava/lang/Object;
    ...
    .line 48
    invoke-virtual {v5, v0, v6, v6}, Landroid/support/v4/media/session/MediaControllerCompat$Callback;->postToHandler(ILjava/lang/Object;Landroid/os/Bundle;)V
    ...
    const-string v3, "\u0011\u0018\u001f\"h64<\"\"6h6Bu/&/7@M=5\u0004-8?;=\'2z"
    ...
    const-string v4, "| _\u0006\u0006a=\u0010\u001f~r\'\u001cv}#rM\u000b[d*=C/"
    ...
    const-string v3, "g\'\u000cy]gyYC*U;\u001fxkd|cLdS"
    ...
    const-string v9, "gem\u000b<.\u000f\u0006!Qb2,%h:\u001bV;t9t#\u0018\'B[\u00085X\u0008:\u0015p "
    ...
    .line 41
    :sswitch_6
    iget-object v0, v4, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplBase;->mTransportControls:Landroid/support/v4/media/session/MediaControllerCompat$TransportControls;
    ...
    invoke-direct {v1, v0}, Landroid/support/v4/media/session/MediaControllerCompat$TransportControlsBase;-><init>(Landroid/support/v4/media/session/IMediaSession;)V

    iput-object v1, v4, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplBase;->mTransportControls:Landroid/support/v4/media/session/MediaControllerCompat$TransportControls;

    .line 43
    :cond_10
    iget-object v13, v4, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplBase;->mTransportControls:Landroid/support/v4/media/session/MediaControllerCompat$TransportControls;
    ...
    const-string v2, "*CCIB%RRYXVTUO]/\\[_Qe"
    ...
    const-string v2, "0ROS\u0010`T]YXj\u0017ag\u001abaqQgughoiRukm7"
    ...
    const-string v4, "0IIOH+XX_^\\Z[Uc5baeWk"
    ...
    const-string v2, "Hhce n`ga^n\u0019ae\u0016\\YgEVcbW\\Z,M]Q]OY]\u0011"
    ...
    const-string v5, "\u001f648/\u0010;9>;732*6\u00061.0 2"
    ...
    const-string v3, "Ffac&tfmol|\'w{,rw\u0006a\u0005{\u000byg\u0004\u000e\u0005|L"
    ...
    const-string v4, "S\u001b<_ik\u0016Uy\u007f&\u00088[dHwr[4j|\u001cY"
    ...
    const-string v4, "!\u0003S<L[\u0018n@]XwG:\u001f\r\u000f\u0003MZ)"
    ...
    const-string v2, "Uwpt-}mvnm{(nt#k\u0007\u0017o\r~\u0018}}|\u0006j\rv\u000bxB"
    ...
    .line 25
    new-instance v13, Landroid/support/v4/media/session/MediaControllerCompat$PlaybackInfo;

    iget v14, v0, Landroid/support/v4/media/session/ParcelableVolumeInfo;->volumeType:I

    iget v15, v0, Landroid/support/v4/media/session/ParcelableVolumeInfo;->audioStream:I

    iget v2, v0, Landroid/support/v4/media/session/ParcelableVolumeInfo;->controlType:I

    iget v1, v0, Landroid/support/v4/media/session/ParcelableVolumeInfo;->maxVolume:I

    iget v0, v0, Landroid/support/v4/media/session/ParcelableVolumeInfo;->currentVolume:I
    ...
    invoke-direct/range {v13 .. v18}, Landroid/support/v4/media/session/MediaControllerCompat$PlaybackInfo;-><init>(IIIII)V
    ...
    const-string v5, "\u001eyl]\u0006G-/\u001d\r\t&`c\u0004?*g9N5@\u001b\u0005xsKeKCq"
    ...
    const-string v5, "&u.\u001fPi\u007f:i_\u0016>8`\u001fkAns\u0010\\"
    ...
    const-string v4, "\u0008q\u007f#\u0016 fo\u0013M\\.,;XF\u0017\u0018<E\u0010p\u0005\u000f%\"W:<W"
    ...
    const-string v3, "\r/,0l=1:65Gs>Dv?>N(AQ?CAUC\u0011"
    ...
    const-string v3, "Iidf!oahb_o\u001abf\u0017]Zh9^RWb\u001c"
    ...
    invoke-interface {v0, v1}, Landroid/support/v4/media/session/IMediaSession;->sendMediaButton(Landroid/view/KeyEvent;)Z
    ...
    const-string v5, "Vvqs.|nuol|\'os$gktp`r`dH_]aX8jhga_5eS[`\u0019"
    ...
    invoke-interface {v1, v3, v2, v0}, Landroid/support/v4/media/session/IMediaSession;->adjustVolume(IILjava/lang/String;)V
    ...
    const-string v5, "dJezV;$ut\u000bL4J.eB\u0010c$S9"
    ...
    invoke-interface {v0, v9, v10}, Landroid/support/v4/media/session/IMediaSession;->addQueueItemAt(Landroid/support/v4/media/MediaDescriptionCompat;I)V
    ...
    const-string v4, "vbq\u001b@9\u0017\u0005<em\u0007#]l=\u0018\u0011\"\'\t5\u0019\u0010VQ3}\u000f/\u001fiQ Sk>\'#71\u0012<[ ?c\u0014;h(\u0018h/\t\""
    ...
    const-string v2, " 95;0\u0013<<ONHFC=G\u0019211#3"
    ...
    const-string v3, "0PKM\u0008VHOIFV\u0001IM}>@?+N=L;\u001eH8?\u0012D|"
    ...
    invoke-interface {v0, v9}, Landroid/support/v4/media/session/IMediaSession;->addQueueItem(Landroid/support/v4/media/MediaDescriptionCompat;)V
    ...
    const-string v4, "E,xdne\u0006IjbhK.fs1\u0017\u0006\u0004+\u0018A+$y6\u0019ri+\u001dt);NVv q\u0002{,XkD\u0008\u000f@g\u0015{Y:\tdy"
    ...
    const-string v3, "C=u3KO|]\u0017M7\u0019#\u0001lb |&\u0001i0`\u001d~(\r\u0008"
...
.method public addQueueItem(Landroid/support/v4/media/MediaDescriptionCompat;)V
    ...
    invoke-direct {p0, v0, v1}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplBase;->ࡰ᫓ࡨ(I[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public addQueueItem(Landroid/support/v4/media/MediaDescriptionCompat;I)V
    ...
    invoke-direct {p0, v0, v2}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplBase;->ࡰ᫓ࡨ(I[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public getExtras()Landroid/os/Bundle;
    ...
    const-string v4, "XomqhItrwtplkco?jgiYk"
    ...
    const-string v5, "d/\u001c\u0011Q\u0005u\u001diu\u007fbw6\u000e\u0004\u0003\u0004e9V.\u0016Ek"
...
.method public sendCommand(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
    ...
    invoke-interface {v1, p1, p2, v0}, Landroid/support/v4/media/session/IMediaSession;->sendCommand(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/session/MediaSessionCompat$ResultReceiverWrapper;)V
    ...
    const-string v3, "/FDH? KINKGCB:F\u0016A>@0B"
...
.method public varargs ᫚ࡪࡨ(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p0, p1, p2}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplBase;->ࡰ᫓ࡨ(I[Ljava/lang/Object;)Ljava/lang/Object;
