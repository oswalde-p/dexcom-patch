...
.method private requestExtraBinder()V
    ...
    invoke-direct {p0, v0, v1}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21;->᫅᫓ࡨ(I[Ljava/lang/Object;)Ljava/lang/Object;
...
.method private varargs ᫅᫓ࡨ(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v0, v2, Landroid/support/v4/media/session/MediaControllerCompat$Callback;->mCallbackObj:Ljava/lang/Object;

    invoke-static {v1, v0}, Landroid/support/v4/media/session/MediaControllerCompatApi21;->unregisterCallback(Ljava/lang/Object;Ljava/lang/Object;)V

    .line 82
    iget-object v6, p0, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21;->mLock:Ljava/lang/Object;
    ...
    .line 85
    iput-object v0, v2, Landroid/support/v4/media/session/MediaControllerCompat$Callback;->mIControllerCallback:Landroid/support/v4/media/session/IMediaControllerCallback;
    ...
    :try_start_2
    const-string v3, "q\\k\u0017|\u0011\u0017\rScd}RKN;:0\n0\u0004"
    ...
    const-string v3, "Bdae\"rfokj|)sy,\u0003|\u0002ux{\u0007\tz\tZy\u0006\u0007}}\u0001\nM"
    ...
    invoke-static {v0, v2, v1}, Landroid/support/v4/media/session/MediaControllerCompatApi21;->setVolumeTo(Ljava/lang/Object;II)V
    ...
    const-string v4, "\n\u0018\u000f\u001e\u001c\u0017\u0013]$\'#$$(+e/mh)\"\"(!n5(78/66v-:9:/=4~\u0013%\u001b*#\u001c&-9(!!\' ?%\'6\'7/7<299"
    ...
    const-string v3, "UcZigb^)ornoosv1z94tmmsl:\u0001s\u0003\u0004z\u0002\u0002Bx\u0006\u0005\u0006z\t\u007fJoclowg\u0003uzk|m\ts\u007fqz"
    ...
    .line 78
    invoke-virtual {p0, v1, v6, v5}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21;->sendCommand(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
    ...
    iget-object v0, v3, Landroid/support/v4/media/session/MediaControllerCompat$Callback;->mCallbackObj:Ljava/lang/Object;

    invoke-static {v1, v0, v2}, Landroid/support/v4/media/session/MediaControllerCompatApi21;->registerCallback(Ljava/lang/Object;Ljava/lang/Object;Landroid/os/Handler;)V

    .line 64
    iget-object v4, p0, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21;->mLock:Ljava/lang/Object;
    ...
    invoke-direct {v1, v3}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21$ExtraCallback;-><init>(Landroid/support/v4/media/session/MediaControllerCompat$Callback;)V
    ...
    .line 68
    iput-object v1, v3, Landroid/support/v4/media/session/MediaControllerCompat$Callback;->mIControllerCallback:Landroid/support/v4/media/session/IMediaControllerCallback;
    :try_end_3
    ...
    .line 70
    invoke-virtual {v3, v0, v2, v2}, Landroid/support/v4/media/session/MediaControllerCompat$Callback;->postToHandler(ILjava/lang/Object;Landroid/os/Bundle;)V
    ...
    :try_start_5
    const-string v3, "AZZ`Y<iipomklftFsrvh|"
    ...
    const-string v3, "/OJL\u0007UGNHEU\u007fHL|N@ABKK;G\u00174>=2018y"
    ...
    .line 72
    :cond_b
    iput-object v2, v3, Landroid/support/v4/media/session/MediaControllerCompat$Callback;->mIControllerCallback:Landroid/support/v4/media/session/IMediaControllerCallback;
    ...
    const-string v5, ":QOSJ+VTYVRNMEQ!LIK;M"
    ...
    const-string v4, "\t+(,h9-621Co:@r=H\u00198HMCJJFLF%OCEPJJ\u0015"
    ...
    .line 58
    new-instance v12, Landroid/support/v4/media/session/MediaControllerCompat$TransportControlsApi21;

    invoke-direct {v12, v0}, Landroid/support/v4/media/session/MediaControllerCompat$TransportControlsApi21;-><init>(Ljava/lang/Object;)V
    ...
    const-string v2, "d{y}tU\u0001~\u0004\u0001|xwo{Kvsuew"
    ...
    const-string v2, "m\u0010\t\rE\u0016\u0006\u000f\u0007\u0006\u0014@\u0007\r;\u0004~\u000fj\u0001\u000b|y\u0001v_~tr<"
    ...
    const-string v2, "6|_G@f9J#o\u0005i\u0018\u0005\u0010I\u001a,Y\u0005Z"
    ...
    .line 35
    new-instance v12, Landroid/support/v4/media/session/MediaControllerCompat$PlaybackInfo;
    ...
    invoke-direct/range {v12 .. v17}, Landroid/support/v4/media/session/MediaControllerCompat$PlaybackInfo;-><init>(IIIII)V
    ...
    .line 30
    :sswitch_11
    iget-object v12, p0, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21;->mControllerObj:Ljava/lang/Object;
    ...
    invoke-static {v0, v1}, Landroid/support/v4/media/session/MediaControllerCompatApi21;->dispatchMediaButtonEvent(Ljava/lang/Object;Landroid/view/KeyEvent;)Z
    ...
    invoke-static {v0, v2, v1}, Landroid/support/v4/media/session/MediaControllerCompatApi21;->adjustVolume(Ljava/lang/Object;II)V
    ...
    const-string v10, "NkQo\\6Qz0B-M,\u000fAJ\u0003P:\u001aqP\u0006M\noAo_%[*Y/\u001b9)l*\u007f)\\]b`8P9\u001fJ(0\u001f\u0004\u001c\u001an\u007f}\u000e|Sz^CYH"
    ...
    const-string v3, "\u001bx\r3o$z5\'U:T$57\u000b.Q$k c\u0003v_Q\"ZH\rnFu\u0002K\u0014h@PT\"\u001egJ\u0007j-f^B\u001bz\u0005\u001ey"
    ...
    const-string v2, ";I@OMHD\u000fUXTUUY\\\u0017`\u001f\u001aZSSYR fYhi`gg(^kjk`ne0DHIeX]N_PkVbT]pSg"
    ...
    .line 25
    invoke-virtual {p0, v1, v8, v7}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21;->sendCommand(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
    ...
    const-string v3, "L\u00067\\1.4y\u0005#ZuN@[\u0003%G4\u0012mm~.?f\u00170\u0010\u000b\u0017Bb}aGn$#cq\u001dEg\"lO\t\u000f@^\u000e,[n+"
    ...
    const-string v5, "nzo|xqk4xysrprs,s0)g^\\`W#gXedY^\\\u001bOZWVIUJ\u0013%5)6-$,1;(\u001f\u001d!\u00185\u0019\u0019&\u0015#\u0019\u001f\"\u0016\u001b\u0019"
    ...
    const-string v2, "We\\kid`+qtpqqux3|;6vooun<\u0003u\u0005\u0006|\u0004\u0004Dz\u0008\u0007\u0008|\u000b\u0002L`de\u0002tyj{l\u0008r~py"
    ...
    .line 14
    invoke-virtual {p0, v0, v4, v3}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21;->sendCommand(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
    ...
    const-string v2, "\u001f46AnC6EF=DDv<H?NJ\u0004R~SVRSSWZ\u0007Y^O`Q\r[P^RYXaZdk\u0018hj`n^rhoou"
    ...
    .line 10
    :sswitch_17
    new-instance v5, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21$ExtraBinderRequestResultReceiver;

    invoke-direct {v5, p0}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21$ExtraBinderRequestResultReceiver;-><init>(Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21;)V

    const-string v2, "kyp\u007f}xt?\u0006\t\u0005\u0006\u0006\n\rG\u0011OJ\u000b\u0004\u0004\n\u0003P\u0017\n\u0019\u001a\u0011\u0018\u0018X\u000f\u001c\u001b\u001c\u0011\u001f\u0016`zy\n\u0016|\u0011\u000e\r|\u001c\u007f\u0008\u000e\u0005\u0007\u0015"
    ...
    invoke-virtual {p0, v1, v0, v5}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21;->sendCommand(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
    ...
    invoke-direct {v1, v2}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21$ExtraCallback;-><init>(Landroid/support/v4/media/session/MediaControllerCompat$Callback;)V
    ...
    .line 5
    iput-object v1, v2, Landroid/support/v4/media/session/MediaControllerCompat$Callback;->mIControllerCallback:Landroid/support/v4/media/session/IMediaControllerCallback;
    ...
    const-string v5, "UljneFqotqmih`l<gdfVh"
    ...
    const-string v4, "h&5R\t8M\u001fr\u001bu\u001098\u001f+;Q\u000f\u0006%0dT\u0018-C\u0006\u0019,q\u0004"
...
.method public addQueueItem(Landroid/support/v4/media/MediaDescriptionCompat;I)V
    ...
    invoke-direct {p0, v0, v2}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21;->᫅᫓ࡨ(I[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public varargs ᫚ࡪࡨ(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p0, p1, p2}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21;->᫅᫓ࡨ(I[Ljava/lang/Object;)Ljava/lang/Object;
