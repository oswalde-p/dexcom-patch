...
.method public static constructor <clinit>()V
    ...
    const-string v2, "Ofdh_?njql]i9dacSe"
    ...
    sput-object v1, Landroid/support/v4/media/MediaBrowserCompat;->TAG:Ljava/lang/String;

    const-string v3, "/=4CA<8\u0003C<<B;\t>OMVSF\u0010H\\YXH\u00169+21LA8J6"
    ...
    sput-object v1, Landroid/support/v4/media/MediaBrowserCompat;->EXTRA_PAGE_SIZE:Ljava/lang/String;

    const-string v4, "@NETRMI\u0014TMMSL\u001aO`^gdW!YmjiY\'J<CB"
    ...
    sput-object v1, Landroid/support/v4/media/MediaBrowserCompat;->EXTRA_PAGE:Ljava/lang/String;

    const-string v4, "z\no\u0014#\u001f.\n[Wd{hV\u001d#P[Ln)b\'\u0018)9y,55KU\ts\u0002"
    ...
    sput-object v1, Landroid/support/v4/media/MediaBrowserCompat;->EXTRA_MEDIA_ID:Ljava/lang/String;

    const-string v2, "d;\r\u0002%i\u000f^z5<\u0019a*pY!\rnFL)db\u000e7\u001fd\u001c/Pg\t\u001e_2Hl\tly\u0002iU"
    ...
    const-string v3, "R`Wfd_[&lokllps.w61qjjpi7kn\u0001v}}>cW`ck[v\\hqihl_cee\u0002imqk"
    ...
    sput-object v1, Landroid/support/v4/media/MediaBrowserCompat;->CUSTOM_ACTION_REMOVE_DOWNLOADED_FILE:Ljava/lang/String;

    const-string v4, "\u0017W9J\'D\u001b\u000b,1\u0018\u001fiO`}ar\u001c\u001f1\u0018(s\u001cVCW,e0\u0013\u0008\u0016y8Q85\u001f"
...
.method private varargs ࡮ࡪࡨ(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {v0, v2, v1}, Landroid/support/v4/media/MediaBrowserCompat$MediaBrowserImpl;->unsubscribe(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserCompat$SubscriptionCallback;)V
    ...
    .line 13
    iget-object v1, p0, Landroid/support/v4/media/MediaBrowserCompat;->mImpl:Landroid/support/v4/media/MediaBrowserCompat$MediaBrowserImpl;

    const/4 v0, 0x0

    invoke-interface {v1, v2, v0}, Landroid/support/v4/media/MediaBrowserCompat$MediaBrowserImpl;->unsubscribe(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserCompat$SubscriptionCallback;)V
    ...
    invoke-interface {v1, v3, v0, v2}, Landroid/support/v4/media/MediaBrowserCompat$MediaBrowserImpl;->subscribe(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserCompat$SubscriptionCallback;)V
    ...
    const-string v4, ".-9:114=r=HuEMEF"
    ...
    const-string v5, "TDTFNS\'A{DMx=DFIM"
    ...
    check-cast v1, Landroid/support/v4/media/MediaBrowserCompat$ItemCallback;

    .line 3
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserCompat;->mImpl:Landroid/support/v4/media/MediaBrowserCompat$MediaBrowserImpl;

    invoke-interface {v0, v2, v1}, Landroid/support/v4/media/MediaBrowserCompat$MediaBrowserImpl;->getItem(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserCompat$ItemCallback;)V
...
.method public connect()V
    ...
    invoke-direct {p0, v0, v1}, Landroid/support/v4/media/MediaBrowserCompat;->࡮ࡪࡨ(I[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public sendCustomAction(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserCompat$CustomActionCallback;)V
    ...
    const-string p2, "Q\u0005DlB\u0015]\u0015U\u0013\u000f5`]<\u001eO7\'PL}"
    ...
    invoke-static {p2, v2, v0}, Liz/࡬ࡪࡨ;->᫅(Ljava/lang/String;SS)Ljava/lang/String;
...
.method public subscribe(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserCompat$SubscriptionCallback;)V
    ...
    const-string v3, ">=EFAA@I\u0003MT\u0002U]QR"
...
.method public varargs ᫚ࡪࡨ(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p0, p1, p2}, Landroid/support/v4/media/MediaBrowserCompat;->࡮ࡪࡨ(I[Ljava/lang/Object;)Ljava/lang/Object;
