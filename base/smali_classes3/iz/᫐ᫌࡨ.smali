...
# direct methods
.method public static ࡡ(J)J
    .locals 10

    long-to-int v0, p0

    invoke-static {v0}, Liz/࡯ᫌࡨ;->᫕(I)I
    ...
    const-wide v8, 0xcc225fb28cc82b5L

    const-wide v2, 0x68050e688d846892L
    ...
    const-wide v2, 0x64c72b935ab715d8L    # 2.934117950493247E177
...
.method public static ࡥ(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    .locals 11
    ...
    invoke-static {p0, v6}, Liz/࡬ࡪࡨ;->᫏(Ljava/nio/ByteBuffer;I)Ljava/nio/ByteBuffer;
    ...
    const-string v4, "s\u000c\u0014\u000c\u0018\u000bN\u0011\u0012\u0004\u0004\u0006\u0014\u007f}8}\u007fz\u0001w2}\u007f}ur~+~qiu&wipcjnhld\u001c]o_^\\h#\u00149[V\\S\u000eYQYQ]P!\u0006"
    ...
    const v0, 0x4e51163c    # 8.7697382E8f
    ...
    const-string v3, "$8A6?EAGAz>RDEES\u0002WST\u0006ZPX\\_\u000ca]\u000fS``gU^d\u0017d^hbpe\u001enf!nhrlzo5y|prv\u0007tt1x|y\u0002zE8k\u007f\t}\u0007\r\t\u000f\t\\C"
...
.method public static ࡲ(Ljava/lang/String;S)Ljava/lang/String;
    .locals 7
...
.method public static ࡳ()V
    ...
    const v0, 0x4e51358f    # 8.7748704E8f
...
.method public static ᫃(Ljava/lang/String;)Ljava/util/List;
    .locals 15
    ...
    const-string v5, "?7M9\u0007OOEI\u000cYIQ\u0010=MU,PTN"
    ...
    const-string v6, "B8L6\u0002?3?7|!A>480"
    ...
    const-string v9, "%\"Qsa\u00035"

    const v11, 0x724534c2
    ...
    const-string v8, "=\u000fs9\u0013\u00152U\u0005)yH\u001cacO-yy\u001aT6"
    ...
    const-string v8, "K\u00135?~$<Q\u000e"

    const v10, 0x5ca4f590
    ...
    :cond_1
    const-string v8, "~v\tt>\u0007\u0003x\tK\u0015\u0005\tGp\u0001tKkoe"
    ...
    const-string v10, "\u0002w\u000cuA\u0008\u0006y{<\u0008u{8cqwKsxu{"
    ...
    const-string v10, "\u000cZ7q{=cc\u0016K\u0007A\r\u001a"

    const v12, 0x1d56bc64

    const v0, -0x1d56a069

    xor-int/2addr v12, v0

    const v11, 0x4edf506e
    ...
    const-string v11, "|r\u0007p<\u0003\u0001tv7\u0003pv3^lrGikc"
    ...
    const v0, 0x356ee83c    # 8.8999855E-7f
...
.method public static ᫊([BLiz/࡭;Liz/࡭᫜;)[B
    .locals 11
    ...
    const v0, 0x4d7d1f3b    # 2.65417648E8f
    ...
    const v3, 0x16ba001f    # 3.0049997E-25f
    ...
    const v0, 0x598437c2    # 4.6520004E15f
    ...
    const v0, 0x4e679963    # 9.7139731E8f
...
.method public static ᫍ(Ljava/io/RandomAccessFile;)Landroid/util/Pair;
    .locals 10
    ...
    const-wide v4, 0x51dad3b7a9a9d754L    # 2.084640783894565E86
    ...
    invoke-static {p0, v0}, Liz/᫞ᫌࡨ;->᫓(Ljava/io/RandomAccessFile;I)Landroid/util/Pair;
    ...
    invoke-static {p0, v1}, Liz/᫞ᫌࡨ;->᫓(Ljava/io/RandomAccessFile;I)Landroid/util/Pair;
...
.method public static ᫒(Liz/ࡰ᫛;)Z
    ...
    invoke-virtual {p0, v5}, Liz/ࡰ᫛;->read([B)I
    ...
    const v0, -0x34ee3ec3    # -9552189.0f
...
.method public static ᫘(ILiz/ࡲ᫞;II[I)I
    .locals 10
    ...
    const v0, 0x4dcb0761    # 4.25782304E8f
    ...
    invoke-static {v5, v1, p2}, Liz/ࡨࡪࡨ;->ࡨ(Ljava/util/Set;Ljava/lang/String;I)V

    const-string v2, "5u\u0003\u000f|W\"\u00192{@:Q\u001b"
    ...
    :cond_4
    invoke-static {v5, p2}, Liz/᫞ᫌࡨ;->ࡩ(Ljava/util/Set;I)V
    ...
    :cond_7
    invoke-static {p3, p2, p0, p1, v7}, Liz/࡯ᫌࡨ;->᫔(IIILiz/ࡲ᫞;Z)I

    move-result v0

    const/4 v3, 0x1

    invoke-static {p3, p2, v0, p1, v3}, Liz/࡯ᫌࡨ;->᫔(IIILiz/ࡲ᫞;Z)I
    ...
    invoke-static {v0, p2, v2, p1, v3}, Liz/࡯ᫌࡨ;->᫔(IIILiz/ࡲ᫞;Z)I
...
.method public static ᫞(IJ)I
    ...
    const-wide v4, 0x3dd968f5b2257048L    # 9.244103792903456E-11

    const-wide v2, 0x224eb99543b4a318L
    ...
    const-wide v2, 0x1f97d160f191d3afL
