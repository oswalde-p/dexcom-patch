...
# direct methods
.method public constructor <init>(Liz/᫞᫓࡭;ILio/reactivex/functions/BiFunction;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    new-array v3, p2, [Lio/reactivex/internal/operators/parallel/ParallelReduceFull$ParallelReduceFullInnerSubscriber;
    ...
    new-instance v0, Lio/reactivex/internal/operators/parallel/ParallelReduceFull$ParallelReduceFullInnerSubscriber;

    invoke-direct {v0, p0, p3}, Lio/reactivex/internal/operators/parallel/ParallelReduceFull$ParallelReduceFullInnerSubscriber;-><init>(Lio/reactivex/internal/operators/parallel/ParallelReduceFull$ParallelReduceFullMainSubscriber;Lio/reactivex/functions/BiFunction;)V
    ...
    :cond_0
    iput-object v3, p0, Lio/reactivex/internal/operators/parallel/ParallelReduceFull$ParallelReduceFullMainSubscriber;->subscribers:[Lio/reactivex/internal/operators/parallel/ParallelReduceFull$ParallelReduceFullInnerSubscriber;
...
.method private varargs ᫚᫐ࡲ(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :sswitch_0
    iget-object v4, p0, Lio/reactivex/internal/operators/parallel/ParallelReduceFull$ParallelReduceFullMainSubscriber;->subscribers:[Lio/reactivex/internal/operators/parallel/ParallelReduceFull$ParallelReduceFullInnerSubscriber;
    ...
    invoke-virtual {v0}, Lio/reactivex/internal/operators/parallel/ParallelReduceFull$ParallelReduceFullInnerSubscriber;->cancel()V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/parallel/ParallelReduceFull$ParallelReduceFullMainSubscriber;->error:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    :goto_1
    invoke-virtual {p0, v0}, Lio/reactivex/internal/operators/parallel/ParallelReduceFull$ParallelReduceFullMainSubscriber;->addValue(Ljava/lang/Object;)Lio/reactivex/internal/operators/parallel/ParallelReduceFull$SlotPair;
    ...
    const-string v4, "r\u0006\u0002;\r~|\ryz\u00073\u0005v\u0005\u0005\u0001{qo*j(u{qp#xbltc"
    ...
    check-cast v2, Lio/reactivex/internal/operators/parallel/ParallelReduceFull$SlotPair;
    ...
    iget-object v0, v2, Lio/reactivex/internal/operators/parallel/ParallelReduceFull$SlotPair;->first:Ljava/lang/Object;
    ...
    check-cast v5, Lio/reactivex/internal/operators/parallel/ParallelReduceFull$SlotPair;

    const/4 v1, 0x0

    if-nez v5, :cond_3

    new-instance v5, Lio/reactivex/internal/operators/parallel/ParallelReduceFull$SlotPair;

    invoke-direct {v5}, Lio/reactivex/internal/operators/parallel/ParallelReduceFull$SlotPair;-><init>()V
    ...
    :cond_3
    invoke-virtual {v5}, Lio/reactivex/internal/operators/parallel/ParallelReduceFull$SlotPair;->tryAcquireSlot()I
    ...
    iput-object v2, v5, Lio/reactivex/internal/operators/parallel/ParallelReduceFull$SlotPair;->first:Ljava/lang/Object;

    :goto_3
    invoke-virtual {v5}, Lio/reactivex/internal/operators/parallel/ParallelReduceFull$SlotPair;->releaseSlot()Z
    ...
    :cond_6
    iput-object v2, v5, Lio/reactivex/internal/operators/parallel/ParallelReduceFull$SlotPair;->second:Ljava/lang/Object;
...
.method public addValue(Ljava/lang/Object;)Lio/reactivex/internal/operators/parallel/ParallelReduceFull$SlotPair;
    ...
    invoke-direct {p0, v0, v1}, Lio/reactivex/internal/operators/parallel/ParallelReduceFull$ParallelReduceFullMainSubscriber;->᫚᫐ࡲ(I[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public varargs ᫚ࡪࡨ(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p0, p1, p2}, Lio/reactivex/internal/operators/parallel/ParallelReduceFull$ParallelReduceFullMainSubscriber;->᫚᫐ࡲ(I[Ljava/lang/Object;)Ljava/lang/Object;
