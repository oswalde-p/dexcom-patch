...
.method public static constructor <clinit>()V
    ...
    new-instance v1, Liz/᫅ࡳ࡭;

    const/4 v0, 0x0

    invoke-direct {v1, v0}, Liz/᫅ࡳ࡭;-><init>(Liz/᫁ࡤ࡭;)V
...
.method public constructor <init>(Ljava/util/Map;)V
    ...
    iput-object p1, p0, Liz/᫃ࡳ࡭;->ࡡ:Ljava/util/Map;
...
.method private varargs ᫙ᪿࡡ(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    check-cast v3, Ljava/io/ObjectOutput;
    ...
    invoke-interface {v3, v0}, Ljava/io/ObjectOutput;->writeByte(I)V

    iget-object v0, p0, Liz/᫃ࡳ࡭;->ࡡ:Ljava/util/Map;

    invoke-interface {v0}, Ljava/util/Map;->size()I

    move-result v0

    invoke-interface {v3, v0}, Ljava/io/ObjectOutput;->writeInt(I)V
    ...
    invoke-interface {v3, v0}, Ljava/io/ObjectOutput;->writeObject(Ljava/lang/Object;)V
    ...
    invoke-static {v8}, Liz/᫕ࡲ࡭;->createMapBuilder(I)Ljava/util/Map;
    ...
    :cond_2
    invoke-static {v3}, Liz/᫕ࡲ࡭;->build(Ljava/util/Map;)Ljava/util/Map;

    move-result-object v0

    iput-object v0, p0, Liz/᫃ࡳ࡭;->ࡡ:Ljava/util/Map;
    ...
    const-string v4, "PhlmgfdfgWU\u0010UZNS^\n_IS[J\u001e\u0003"
