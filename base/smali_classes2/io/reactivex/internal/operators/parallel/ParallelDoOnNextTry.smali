...
.method private varargs ࡳ᫞ࡲ(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    new-instance v2, Lio/reactivex/internal/operators/parallel/ParallelDoOnNextTry$ParallelDoOnNextConditionalSubscriber;

    check-cast v3, Lio/reactivex/internal/fuseable/ConditionalSubscriber;

    iget-object v1, p0, Lio/reactivex/internal/operators/parallel/ParallelDoOnNextTry;->onNext:Lio/reactivex/functions/Consumer;

    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelDoOnNextTry;->errorHandler:Lio/reactivex/functions/BiFunction;

    invoke-direct {v2, v3, v1, v0}, Lio/reactivex/internal/operators/parallel/ParallelDoOnNextTry$ParallelDoOnNextConditionalSubscriber;-><init>(Lio/reactivex/internal/fuseable/ConditionalSubscriber;Lio/reactivex/functions/Consumer;Lio/reactivex/functions/BiFunction;)V
    ...
    :cond_1
    new-instance v2, Lio/reactivex/internal/operators/parallel/ParallelDoOnNextTry$ParallelDoOnNextSubscriber;

    iget-object v1, p0, Lio/reactivex/internal/operators/parallel/ParallelDoOnNextTry;->onNext:Lio/reactivex/functions/Consumer;

    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelDoOnNextTry;->errorHandler:Lio/reactivex/functions/BiFunction;

    invoke-direct {v2, v3, v1, v0}, Lio/reactivex/internal/operators/parallel/ParallelDoOnNextTry$ParallelDoOnNextSubscriber;-><init>(Liz/᫞᫓࡭;Lio/reactivex/functions/Consumer;Lio/reactivex/functions/BiFunction;)V
...
.method public parallelism()I
    ...
    invoke-direct {p0, v0, v1}, Lio/reactivex/internal/operators/parallel/ParallelDoOnNextTry;->ࡳ᫞ࡲ(I[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public varargs ᫚ࡪࡨ(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p0, p1, p2}, Lio/reactivex/internal/operators/parallel/ParallelDoOnNextTry;->ࡳ᫞ࡲ(I[Ljava/lang/Object;)Ljava/lang/Object;
