...
.method public static amb(Ljava/lang/Iterable;)Lio/reactivex/Completable;
    ...
    invoke-static {v0, v1}, Lio/reactivex/Completable;->ࡪ࡫ࡲ(I[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static concat(Liz/᫋᫓࡭;)Lio/reactivex/Completable;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static concat(Liz/᫋᫓࡭;I)Lio/reactivex/Completable;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0, v2}, Lio/reactivex/Completable;->ࡪ࡫ࡲ(I[Ljava/lang/Object;)Ljava/lang/Object;
...
.method private doOnLifecycle(Lio/reactivex/functions/Consumer;Lio/reactivex/functions/Consumer;Lio/reactivex/functions/Action;Lio/reactivex/functions/Action;Lio/reactivex/functions/Action;Lio/reactivex/functions/Action;)Lio/reactivex/Completable;
    ...
    invoke-direct {p0, v0, v1}, Lio/reactivex/Completable;->ᫌ࡫ࡲ(I[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static fromPublisher(Liz/᫋᫓࡭;)Lio/reactivex/Completable;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static merge(Liz/᫋᫓࡭;)Lio/reactivex/Completable;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static merge(Liz/᫋᫓࡭;I)Lio/reactivex/Completable;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static merge0(Liz/᫋᫓࡭;IZ)Lio/reactivex/Completable;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static mergeDelayError(Liz/᫋᫓࡭;)Lio/reactivex/Completable;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static mergeDelayError(Liz/᫋᫓࡭;I)Lio/reactivex/Completable;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private timeout0(JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;Lio/reactivex/CompletableSource;)Lio/reactivex/Completable;
    ...
    invoke-direct {p0, v0, v2}, Lio/reactivex/Completable;->ᫌ࡫ࡲ(I[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static varargs ࡪ࡫ࡲ(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v4, "SG\u0005K 482[70\u001cIq"
    ...
    instance-of v0, v5, Lio/reactivex/Completable;

    if-eqz v0, :cond_0

    check-cast v5, Lio/reactivex/Completable;

    invoke-static {v5}, Lio/reactivex/plugins/RxJavaPlugins;->onAssembly(Lio/reactivex/Completable;)Lio/reactivex/Completable;
    ...
    invoke-direct {v0, v5}, Lio/reactivex/internal/operators/completable/CompletableFromUnsafeSource;-><init>(Lio/reactivex/CompletableSource;)V
    ...
    const-string v5, ";HGKHBR@BMG)YSI[QXX\u000bU`\u000e]e]^"
    ...
    const-string v3, "rv\u007f{y|my&nw#pvlk"
    ...
    invoke-direct {v0, v8, v7, v6, v9}, Lio/reactivex/internal/operators/completable/CompletableUsing;-><init>(Ljava/util/concurrent/Callable;Lio/reactivex/functions/Function;Lio/reactivex/functions/Consumer;Z)V
    ...
    invoke-static {v3, v2, v1, v0}, Lio/reactivex/Completable;->using(Ljava/util/concurrent/Callable;Lio/reactivex/functions/Function;Lio/reactivex/functions/Consumer;Z)Lio/reactivex/Completable;
    ...
    instance-of v0, v4, Lio/reactivex/Completable;

    if-nez v0, :cond_4

    new-instance v0, Lio/reactivex/internal/operators/completable/CompletableFromUnsafeSource;

    invoke-direct {v0, v4}, Lio/reactivex/internal/operators/completable/CompletableFromUnsafeSource;-><init>(Lio/reactivex/CompletableSource;)V
    ...
    const-string v4, "x\u0018\u0007B\u0017\u000fE\u001c\u001a \u000b\u0011\u0015s \u0014t\tv:Z\u0008\u0003\u0007\u0008\u0002\u000e{\u0002\r\u0003Gd"
    ...
    const-string v4, "3LE22]ZjQ`z~@\u0015V]D\u00112; \u001e%8\u0008\u007f\u001aOl`VZz>O!q\r=M@B#Au\u0010sH\u0008C\u0003\u001bT4Y\u0015Ij"
    ...
    invoke-static {v5, v3}, Lio/reactivex/internal/functions/ObjectHelper;->requireNonNull(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-direct {v0, v1, v2, v5, v6}, Lio/reactivex/internal/operators/completable/CompletableTimer;-><init>(JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;)V
    ...
    invoke-static {v2, v3, v1, v0}, Lio/reactivex/Completable;->timer(JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;)Lio/reactivex/Completable;
    ...
    invoke-direct {v0, v5}, Lio/reactivex/internal/operators/completable/CompletableMergeDelayErrorIterable;-><init>(Ljava/lang/Iterable;)V
    ...
    invoke-static {v2, v1, v0}, Lio/reactivex/Completable;->merge0(Liz/᫋᫓࡭;IZ)Lio/reactivex/Completable;
    ...
    invoke-direct {v0, v6}, Lio/reactivex/internal/operators/completable/CompletableMergeDelayErrorArray;-><init>([Lio/reactivex/CompletableSource;)V
    ...
    invoke-direct {v0, v5}, Lio/reactivex/internal/operators/completable/CompletableMergeArray;-><init>([Lio/reactivex/CompletableSource;)V
    ...
    const-string v4, "C@GE7:IvALyIQIJ"
    ...
    invoke-static {v6, v1}, Lio/reactivex/internal/functions/ObjectHelper;->verifyPositive(ILjava/lang/String;)I

    new-instance v0, Lio/reactivex/internal/operators/completable/CompletableMerge;

    invoke-direct {v0, v7, v6, v8}, Lio/reactivex/internal/operators/completable/CompletableMerge;-><init>(Liz/᫋᫓࡭;IZ)V
    ...
    const-string v2, "VQVRBCP{DMxFLBA"
    ...
    invoke-direct {v0, v6}, Lio/reactivex/internal/operators/completable/CompletableMergeIterable;-><init>(Ljava/lang/Iterable;)V
    ...
    invoke-direct {v0, v5}, Lio/reactivex/internal/operators/completable/CompletableFromSingle;-><init>(Lio/reactivex/SingleSource;)V
    ...
    invoke-direct {v0, v6}, Lio/reactivex/internal/operators/completable/CompletableFromRunnable;-><init>(Ljava/lang/Runnable;)V
    ...
    invoke-direct {v0, v5}, Lio/reactivex/internal/operators/completable/CompletableFromPublisher;-><init>(Liz/᫋᫓࡭;)V
    ...
    invoke-direct {v0, v4}, Lio/reactivex/internal/operators/completable/CompletableFromObservable;-><init>(Lio/reactivex/ObservableSource;)V
    ...
    invoke-static {v5}, Lio/reactivex/internal/functions/Functions;->futureAction(Ljava/util/concurrent/Future;)Lio/reactivex/functions/Action;
    ...
    invoke-direct {v0, v3}, Lio/reactivex/internal/operators/completable/CompletableFromCallable;-><init>(Ljava/util/concurrent/Callable;)V
    ...
    invoke-direct {v0, v6}, Lio/reactivex/internal/operators/completable/CompletableFromAction;-><init>(Lio/reactivex/functions/Action;)V
    ...
    const-string v3, "\u0008\u0004^c.J0YtJ]pHIY\u000c\u0011\u0013k3m"
    ...
    invoke-direct {v0, v6}, Lio/reactivex/internal/operators/completable/CompletableErrorSupplier;-><init>(Ljava/util/concurrent/Callable;)V
    ...
    invoke-direct {v0, v4}, Lio/reactivex/internal/operators/completable/CompletableError;-><init>(Ljava/lang/Throwable;)V
    ...
    invoke-direct {v0, v7}, Lio/reactivex/internal/operators/completable/CompletableDefer;-><init>(Ljava/util/concurrent/Callable;)V
    ...
    check-cast v3, Lio/reactivex/CompletableOnSubscribe;

    const-string v2, ";8?=/2m8Cp@H@A"
    ...
    invoke-direct {v0, v3}, Lio/reactivex/internal/operators/completable/CompletableCreate;-><init>(Lio/reactivex/CompletableOnSubscribe;)V
    ...
    invoke-direct {v0, v4}, Lio/reactivex/internal/operators/completable/CompletableConcatArray;-><init>([Lio/reactivex/CompletableSource;)V
    ...
    invoke-direct {v0, v3}, Lio/reactivex/internal/operators/completable/CompletableConcatIterable;-><init>(Ljava/lang/Iterable;)V
    ...
    const-string v4, "totp`an\u001abk\u0017dj`_"
    ...
    invoke-static {v7, v1}, Lio/reactivex/internal/functions/ObjectHelper;->verifyPositive(ILjava/lang/String;)I

    new-instance v0, Lio/reactivex/internal/operators/completable/CompletableConcat;

    invoke-direct {v0, v6, v7}, Lio/reactivex/internal/operators/completable/CompletableConcat;-><init>(Liz/᫋᫓࡭;I)V
    ...
    invoke-static {v1, v0}, Lio/reactivex/Completable;->concat(Liz/᫋᫓࡭;I)Lio/reactivex/Completable;
    ...
    const-string v6, "a^ecUXg\u0015_j\u0018gogh"
    ...
    :cond_1e
    new-instance v1, Lio/reactivex/internal/operators/completable/CompletableAmb;

    const/4 v0, 0x0

    invoke-direct {v1, v4, v0}, Lio/reactivex/internal/operators/completable/CompletableAmb;-><init>([Lio/reactivex/CompletableSource;Ljava/lang/Iterable;)V
    ...
    invoke-direct {v1, v0, v6}, Lio/reactivex/internal/operators/completable/CompletableAmb;-><init>([Lio/reactivex/CompletableSource;Ljava/lang/Iterable;)V
...
.method private varargs ᫂࡫ࡲ(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :try_start_0
    invoke-static {v14, v8}, Lio/reactivex/plugins/RxJavaPlugins;->onSubscribe(Lio/reactivex/Completable;Lio/reactivex/CompletableObserver;)Lio/reactivex/CompletableObserver;

    move-result-object v0

    invoke-virtual {v14, v0}, Lio/reactivex/Completable;->subscribeActual(Lio/reactivex/CompletableObserver;)V
    ...
    :sswitch_1
    new-instance v5, Lio/reactivex/observers/TestObserver;

    invoke-direct {v5}, Lio/reactivex/observers/TestObserver;-><init>()V

    invoke-virtual {v14, v5}, Lio/reactivex/Completable;->subscribe(Lio/reactivex/CompletableObserver;)V
    ...
    invoke-direct {v0, v14, v6}, Lio/reactivex/internal/operators/completable/CompletableSubscribeOn;-><init>(Lio/reactivex/CompletableSource;Lio/reactivex/Scheduler;)V
    ...
    invoke-direct {v5, v6, v4}, Lio/reactivex/internal/observers/CallbackCompletableObserver;-><init>(Lio/reactivex/functions/Consumer;Lio/reactivex/functions/Action;)V
    ...
    invoke-direct {v5, v6}, Lio/reactivex/internal/observers/CallbackCompletableObserver;-><init>(Lio/reactivex/functions/Action;)V
    ...
    :sswitch_6
    new-instance v5, Lio/reactivex/internal/observers/EmptyCompletableObserver;

    invoke-direct {v5}, Lio/reactivex/internal/observers/EmptyCompletableObserver;-><init>()V
    ...
    invoke-virtual {v14}, Lio/reactivex/Completable;->toObservable()Lio/reactivex/Observable;

    move-result-object v0

    invoke-virtual {v3, v0}, Lio/reactivex/Observable;->concatWith(Lio/reactivex/ObservableSource;)Lio/reactivex/Observable;
    ...
    invoke-virtual {v14}, Lio/reactivex/Completable;->toFlowable()Lio/reactivex/Flowable;

    move-result-object v0

    invoke-virtual {v0, v5}, Lio/reactivex/Flowable;->startWith(Liz/᫋᫓࡭;)Lio/reactivex/Flowable;
    ...
    new-array v1, v0, [Lio/reactivex/CompletableSource;
    ...
    invoke-static {v0}, Lio/reactivex/Completable;->fromPublisher(Liz/᫋᫓࡭;)Lio/reactivex/Completable;
    ...
    invoke-direct {v0, v14, v5}, Lio/reactivex/internal/operators/completable/CompletableResumeNext;-><init>(Lio/reactivex/CompletableSource;Lio/reactivex/functions/Function;)V
    ...
    const-string v6, "UVHFJC@RB{DMxFLBA"
    ...
    invoke-direct {v0, v14, v5}, Lio/reactivex/internal/operators/completable/CompletableOnErrorComplete;-><init>(Lio/reactivex/CompletableSource;Lio/reactivex/functions/Predicate;)V
    ...
    invoke-virtual {v14, v0}, Lio/reactivex/Completable;->onErrorComplete(Lio/reactivex/functions/Predicate;)Lio/reactivex/Completable;
    ...
    invoke-direct {v0, v14, v5}, Lio/reactivex/internal/operators/completable/CompletableObserveOn;-><init>(Lio/reactivex/CompletableSource;Lio/reactivex/Scheduler;)V
    ...
    check-cast v6, Lio/reactivex/CompletableOperator;

    const-string v3, "CA\u001e:6Cm6?j8>43"
    ...
    invoke-direct {v0, v14, v6}, Lio/reactivex/internal/operators/completable/CompletableLift;-><init>(Lio/reactivex/CompletableSource;Lio/reactivex/CompletableOperator;)V
    ...
    invoke-direct {v0, v14}, Lio/reactivex/internal/operators/completable/CompletableHide;-><init>(Lio/reactivex/CompletableSource;)V
    ...
    sget-object v17, Lio/reactivex/internal/functions/Functions;->EMPTY_ACTION:Lio/reactivex/functions/Action;
    ...
    invoke-direct/range {v14 .. v20}, Lio/reactivex/Completable;->doOnLifecycle(Lio/reactivex/functions/Consumer;Lio/reactivex/functions/Consumer;Lio/reactivex/functions/Action;Lio/reactivex/functions/Action;Lio/reactivex/functions/Action;Lio/reactivex/functions/Action;)Lio/reactivex/Completable;
    ...
    const-string v3, "db8hV^c\u000eV_\u000bX^TS"
    ...
    invoke-direct {v0, v14, v5}, Lio/reactivex/internal/operators/completable/CompletableDoOnEvent;-><init>(Lio/reactivex/CompletableSource;Lio/reactivex/functions/Consumer;)V
    ...
    invoke-direct {v0, v14, v6}, Lio/reactivex/internal/operators/completable/CompletableDoFinally;-><init>(Lio/reactivex/CompletableSource;Lio/reactivex/functions/Action;)V
    ...
    const-string v2, "I8<86F<4@l5>i7=32"
    ...
    new-instance v13, Lio/reactivex/internal/operators/completable/CompletableDelay;

    move-object/from16 v17, v4

    move-object/from16 p0, v3

    invoke-direct/range {v13 .. v19}, Lio/reactivex/internal/operators/completable/CompletableDelay;-><init>(Lio/reactivex/CompletableSource;JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;Z)V

    invoke-static {v13}, Lio/reactivex/plugins/RxJavaPlugins;->onAssembly(Lio/reactivex/Completable;)Lio/reactivex/Completable;
    ...
    invoke-virtual/range {v14 .. v19}, Lio/reactivex/Completable;->delay(JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;Z)Lio/reactivex/Completable;
    ...
    check-cast v6, Lio/reactivex/CompletableTransformer;

    const-string v5, "F5c\tmxA\\7\u0007\u0014\u0019\u0003d\u00117],k"
    ...
    invoke-interface {v0, v14}, Lio/reactivex/CompletableTransformer;->apply(Lio/reactivex/Completable;)Lio/reactivex/CompletableSource;
    ...
    invoke-direct {v0, v14}, Lio/reactivex/internal/operators/completable/CompletableCache;-><init>(Lio/reactivex/CompletableSource;)V
    ...
    invoke-virtual {v14, v0}, Lio/reactivex/Completable;->subscribe(Lio/reactivex/CompletableObserver;)V

    invoke-virtual {v0, v1, v2, v7}, Lio/reactivex/internal/observers/BlockingMultiObserver;->blockingGetError(JLjava/util/concurrent/TimeUnit;)Ljava/lang/Throwable;
    ...
    invoke-static {v6, v3}, Lio/reactivex/internal/functions/ObjectHelper;->requireNonNull(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-virtual {v0, v1, v2, v6}, Lio/reactivex/internal/observers/BlockingMultiObserver;->blockingAwait(JLjava/util/concurrent/TimeUnit;)Z
    ...
    invoke-direct {v0, v7, v14}, Lio/reactivex/internal/operators/single/SingleDelayWithCompletable;-><init>(Lio/reactivex/SingleSource;Lio/reactivex/CompletableSource;)V
    ...
    new-instance v1, Lio/reactivex/internal/operators/observable/ObservableDelaySubscriptionOther;

    invoke-virtual {v14}, Lio/reactivex/Completable;->toObservable()Lio/reactivex/Observable;

    move-result-object v0

    invoke-direct {v1, v3, v0}, Lio/reactivex/internal/operators/observable/ObservableDelaySubscriptionOther;-><init>(Lio/reactivex/ObservableSource;Lio/reactivex/ObservableSource;)V
    ...
    invoke-direct {v0, v6, v14}, Lio/reactivex/internal/operators/maybe/MaybeDelayWithCompletable;-><init>(Lio/reactivex/MaybeSource;Lio/reactivex/CompletableSource;)V
    ...
    new-instance v1, Lio/reactivex/internal/operators/flowable/FlowableDelaySubscriptionOther;

    invoke-virtual {v14}, Lio/reactivex/Completable;->toFlowable()Lio/reactivex/Flowable;

    move-result-object v0

    invoke-direct {v1, v5, v0}, Lio/reactivex/internal/operators/flowable/FlowableDelaySubscriptionOther;-><init>(Liz/᫋᫓࡭;Liz/᫋᫓࡭;)V
    ...
    invoke-virtual {v14, v0}, Lio/reactivex/Completable;->concatWith(Lio/reactivex/CompletableSource;)Lio/reactivex/Completable;
    ...
    invoke-static {v1}, Lio/reactivex/Completable;->ambArray([Lio/reactivex/CompletableSource;)Lio/reactivex/Completable;
...
.method private varargs ᫌ࡫ࡲ(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v0, v3, v2}, Lio/reactivex/Completable;->᫂࡫ࡲ(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v10, "!C*\u000bx?N\u00077d$\u0018sD[8m"
    ...
    new-instance v13, Lio/reactivex/internal/operators/completable/CompletableTimeout;
    ...
    invoke-direct/range {v13 .. v19}, Lio/reactivex/internal/operators/completable/CompletableTimeout;-><init>(Lio/reactivex/CompletableSource;JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;Lio/reactivex/CompletableSource;)V
    ...
    const-string v10, "tNpw-MvYH@l\u001fWB<"
    ...
    const-string v3, "11\u00074374.>0k6An>F>?"
    ...
    invoke-static {v11, v10, v1}, Liz/᫙ᫌࡨ;->ࡤ(Ljava/lang/String;SS)Ljava/lang/String;

    move-result-object v1

    invoke-static {v5, v1}, Lio/reactivex/internal/functions/ObjectHelper;->requireNonNull(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;

    const-string v3, "HvwDb\u0019\u0012;$DAW(\u0011HR:\u001a[ &d}\u0002"
    ...
    new-instance v10, Lio/reactivex/internal/operators/completable/CompletablePeek;
    ...
    invoke-direct/range {v10 .. v17}, Lio/reactivex/internal/operators/completable/CompletablePeek;-><init>(Lio/reactivex/CompletableSource;Lio/reactivex/functions/Consumer;Lio/reactivex/functions/Consumer;Lio/reactivex/functions/Action;Lio/reactivex/functions/Action;Lio/reactivex/functions/Action;Lio/reactivex/functions/Action;)V

    invoke-static {v10}, Lio/reactivex/plugins/RxJavaPlugins;->onAssembly(Lio/reactivex/Completable;)Lio/reactivex/Completable;
    ...
    new-instance v1, Lio/reactivex/internal/operators/completable/CompletableDisposeOn;

    invoke-direct {v1, v0, v7}, Lio/reactivex/internal/operators/completable/CompletableDisposeOn;-><init>(Lio/reactivex/CompletableSource;Lio/reactivex/Scheduler;)V
    ...
    const-string v6, "CNKMH@NBGE,6@H7p9Bm;A76"
    ...
    new-instance v2, Lio/reactivex/internal/operators/completable/CompletableToSingle;

    const/4 v1, 0x0

    invoke-direct {v2, v0, v1, v5}, Lio/reactivex/internal/operators/completable/CompletableToSingle;-><init>(Lio/reactivex/CompletableSource;Ljava/util/concurrent/Callable;Ljava/lang/Object;)V

    invoke-static {v2}, Lio/reactivex/plugins/RxJavaPlugins;->onAssembly(Lio/reactivex/Single;)Lio/reactivex/Single;
    ...
    invoke-direct {v2, v0, v6, v1}, Lio/reactivex/internal/operators/completable/CompletableToSingle;-><init>(Lio/reactivex/CompletableSource;Ljava/util/concurrent/Callable;Ljava/lang/Object;)V
    ...
    :sswitch_5
    instance-of v1, v0, Lio/reactivex/internal/fuseable/FuseToObservable;
    ...
    :cond_f
    new-instance v1, Lio/reactivex/internal/operators/completable/CompletableToObservable;

    invoke-direct {v1, v0}, Lio/reactivex/internal/operators/completable/CompletableToObservable;-><init>(Lio/reactivex/CompletableSource;)V
    ...
    :sswitch_6
    instance-of v1, v0, Lio/reactivex/internal/fuseable/FuseToMaybe;
    ...
    :cond_10
    new-instance v1, Lio/reactivex/internal/operators/maybe/MaybeFromCompletable;

    invoke-direct {v1, v0}, Lio/reactivex/internal/operators/maybe/MaybeFromCompletable;-><init>(Lio/reactivex/CompletableSource;)V
    ...
    :sswitch_7
    instance-of v1, v0, Lio/reactivex/internal/fuseable/FuseToFlowable;
    ...
    invoke-direct {v1, v0}, Lio/reactivex/internal/operators/completable/CompletableToFlowable;-><init>(Lio/reactivex/CompletableSource;)V
    ...
    check-cast v8, Lio/reactivex/CompletableSource;

    const-string v4, "y}tpx%qz2\u007f\n\u007fz"
    ...
    invoke-direct/range {v10 .. v15}, Lio/reactivex/Completable;->timeout0(JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;Lio/reactivex/CompletableSource;)Lio/reactivex/Completable;
    ...
    invoke-direct/range {v3 .. v8}, Lio/reactivex/Completable;->timeout0(JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;Lio/reactivex/CompletableSource;)Lio/reactivex/Completable;
    ...
    invoke-direct/range {v12 .. v17}, Lio/reactivex/Completable;->timeout0(JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;Lio/reactivex/CompletableSource;)Lio/reactivex/Completable;
    ...
    invoke-direct/range {v2 .. v7}, Lio/reactivex/Completable;->timeout0(JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;Lio/reactivex/CompletableSource;)Lio/reactivex/Completable;
    ...
    invoke-virtual {v1}, Lio/reactivex/observers/TestObserver;->cancel()V
...
.method public final andThen(Liz/᫋᫓࡭;)Lio/reactivex/Flowable;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public final startWith(Liz/᫋᫓࡭;)Lio/reactivex/Flowable;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public varargs ᫚ࡪࡨ(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p0, p1, p2}, Lio/reactivex/Completable;->ᫌ࡫ࡲ(I[Ljava/lang/Object;)Ljava/lang/Object;
