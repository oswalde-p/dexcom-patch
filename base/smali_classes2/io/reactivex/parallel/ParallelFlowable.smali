...
.method public static from(Liz/᫋᫓࡭;)Lio/reactivex/parallel/ParallelFlowable;
    .locals 2
    .param p0    # Liz/᫋᫓࡭;
    ...
    invoke-static {v0, v1}, Lio/reactivex/parallel/ParallelFlowable;->᫂࡬ࡡ(I[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static from(Liz/᫋᫓࡭;I)Lio/reactivex/parallel/ParallelFlowable;
    .locals 3
    .param p0    # Liz/᫋᫓࡭;
        .annotation build Lio/reactivex/annotations/NonNull;
        .end annotation
    ...
    invoke-static {v0, v2}, Lio/reactivex/parallel/ParallelFlowable;->᫂࡬ࡡ(I[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static from(Liz/᫋᫓࡭;II)Lio/reactivex/parallel/ParallelFlowable;
    .locals 3
    .param p0    # Liz/᫋᫓࡭;
        .annotation build Lio/reactivex/annotations/NonNull;
        .end annotation
...
.method public static varargs fromArray([Liz/᫋᫓࡭;)Lio/reactivex/parallel/ParallelFlowable;
    .locals 2
    .param p0    # [Liz/᫋᫓࡭;
        .annotation build Lio/reactivex/annotations/NonNull;
        .end annotation
...
.method public static varargs ᫂࡬ࡡ(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v0, v1}, Lio/reactivex/internal/operators/parallel/ParallelFromArray;-><init>([Liz/᫋᫓࡭;)V
    ...
    const-string v5, "*6DBsEK9DBMCAOQ~NPV\u0003WZVWW[^PP"
    ...
    invoke-direct {v0, v6, v5, v7}, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher;-><init>(Liz/᫋᫓࡭;II)V
    ...
    invoke-static {v2, v1, v0}, Lio/reactivex/parallel/ParallelFlowable;->from(Liz/᫋᫓࡭;II)Lio/reactivex/parallel/ParallelFlowable;
...
.method private varargs ᫗࡬ࡡ(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v13}, Lio/reactivex/parallel/ParallelFlowable;->parallelism()I
    ...
    invoke-static {v6, v1}, Lio/reactivex/internal/subscriptions/EmptySubscription;->error(Ljava/lang/Throwable;Liz/᫞᫓࡭;)V
    ...
    invoke-static {v5}, Lio/reactivex/internal/functions/Functions;->createArrayList(I)Ljava/util/concurrent/Callable;
    ...
    invoke-virtual {v13, v1, v0}, Lio/reactivex/parallel/ParallelFlowable;->reduce(Ljava/util/concurrent/Callable;Lio/reactivex/functions/BiFunction;)Lio/reactivex/parallel/ParallelFlowable;

    move-result-object v1

    new-instance v0, Lio/reactivex/internal/util/SorterFunction;

    invoke-direct {v0, v2}, Lio/reactivex/internal/util/SorterFunction;-><init>(Ljava/util/Comparator;)V

    invoke-virtual {v1, v0}, Lio/reactivex/parallel/ParallelFlowable;->map(Lio/reactivex/functions/Function;)Lio/reactivex/parallel/ParallelFlowable;

    move-result-object v1

    new-instance v0, Lio/reactivex/internal/util/MergerBiFunction;

    invoke-direct {v0, v2}, Lio/reactivex/internal/util/MergerBiFunction;-><init>(Ljava/util/Comparator;)V

    invoke-virtual {v1, v0}, Lio/reactivex/parallel/ParallelFlowable;->reduce(Lio/reactivex/functions/BiFunction;)Lio/reactivex/Flowable;
    ...
    invoke-virtual {v13, v1, v0}, Lio/reactivex/parallel/ParallelFlowable;->toSortedList(Ljava/util/Comparator;I)Lio/reactivex/Flowable;
    ...
    const-string v2, "R][bP\\]MY\u0006NW\u0003PVLK"
    ...
    invoke-direct {v0, v3}, Lio/reactivex/internal/util/SorterFunction;-><init>(Ljava/util/Comparator;)V
    ...
    invoke-direct {v0, v1, v3}, Lio/reactivex/internal/operators/parallel/ParallelSortedJoin;-><init>(Lio/reactivex/parallel/ParallelFlowable;Ljava/util/Comparator;)V
    ...
    invoke-virtual {v13, v1, v0}, Lio/reactivex/parallel/ParallelFlowable;->sorted(Ljava/util/Comparator;I)Lio/reactivex/Flowable;
    ...
    new-instance v1, Lio/reactivex/internal/operators/parallel/ParallelJoin;

    const/4 v0, 0x1

    invoke-direct {v1, v13, v6, v0}, Lio/reactivex/internal/operators/parallel/ParallelJoin;-><init>(Lio/reactivex/parallel/ParallelFlowable;IZ)V
    ...
    invoke-virtual {v13, v0}, Lio/reactivex/parallel/ParallelFlowable;->sequentialDelayError(I)Lio/reactivex/Flowable;
    ...
    invoke-static {v3, v0}, Lio/reactivex/internal/functions/ObjectHelper;->verifyPositive(ILjava/lang/String;)I

    new-instance v1, Lio/reactivex/internal/operators/parallel/ParallelJoin;

    const/4 v0, 0x0

    invoke-direct {v1, v13, v3, v0}, Lio/reactivex/internal/operators/parallel/ParallelJoin;-><init>(Lio/reactivex/parallel/ParallelFlowable;IZ)V
    ...
    invoke-virtual {v13, v0}, Lio/reactivex/parallel/ParallelFlowable;->sequential(I)Lio/reactivex/Flowable;
    ...
    invoke-direct {v0, v13, v5, v6}, Lio/reactivex/internal/operators/parallel/ParallelRunOn;-><init>(Lio/reactivex/parallel/ParallelFlowable;Lio/reactivex/Scheduler;I)V
    ...
    invoke-virtual {v13, v1, v0}, Lio/reactivex/parallel/ParallelFlowable;->runOn(Lio/reactivex/Scheduler;I)Lio/reactivex/parallel/ParallelFlowable;
    ...
    invoke-direct {v0, v13, v5, v6}, Lio/reactivex/internal/operators/parallel/ParallelReduce;-><init>(Lio/reactivex/parallel/ParallelFlowable;Ljava/util/concurrent/Callable;Lio/reactivex/functions/BiFunction;)V
    ...
    invoke-direct {v0, v13, v6}, Lio/reactivex/internal/operators/parallel/ParallelReduceFull;-><init>(Lio/reactivex/parallel/ParallelFlowable;Lio/reactivex/functions/BiFunction;)V
    ...
    const-string v4, "P^_]a8R`W`Zh\u0017al\u001aiqij"
    ...
    invoke-direct {v0, v13, v5, v6}, Lio/reactivex/internal/operators/parallel/ParallelMapTry;-><init>(Lio/reactivex/parallel/ParallelFlowable;Lio/reactivex/functions/Function;Lio/reactivex/functions/BiFunction;)V
    ...
    invoke-direct {v0, v13, v6}, Lio/reactivex/internal/operators/parallel/ParallelMap;-><init>(Lio/reactivex/parallel/ParallelFlowable;Lio/reactivex/functions/Function;)V
    ...
    check-cast v14, Lio/reactivex/functions/Function;
    ...
    const-string v2, "QDRQEQ}FOzHNDC"
    ...
    invoke-static {v4, v0}, Lio/reactivex/internal/functions/ObjectHelper;->verifyPositive(ILjava/lang/String;)I
    ...
    new-instance v12, Lio/reactivex/internal/operators/parallel/ParallelFlatMap;

    move/from16 v16, v4

    move/from16 v17, v5

    invoke-direct/range {v12 .. v17}, Lio/reactivex/internal/operators/parallel/ParallelFlatMap;-><init>(Lio/reactivex/parallel/ParallelFlowable;Lio/reactivex/functions/Function;ZII)V

    invoke-static {v12}, Lio/reactivex/plugins/RxJavaPlugins;->onAssembly(Lio/reactivex/parallel/ParallelFlowable;)Lio/reactivex/parallel/ParallelFlowable;
    ...
    invoke-virtual {v13, v3, v2, v1, v0}, Lio/reactivex/parallel/ParallelFlowable;->flatMap(Lio/reactivex/functions/Function;ZII)Lio/reactivex/parallel/ParallelFlowable;
    ...
    invoke-virtual {v13, v3, v2, v0, v1}, Lio/reactivex/parallel/ParallelFlowable;->flatMap(Lio/reactivex/functions/Function;ZII)Lio/reactivex/parallel/ParallelFlowable;
    ...
    invoke-virtual {v13, v3, v1, v0, v2}, Lio/reactivex/parallel/ParallelFlowable;->flatMap(Lio/reactivex/functions/Function;ZII)Lio/reactivex/parallel/ParallelFlowable;
    ...
    const-string v2, "Vba]_4LXMTLX\u0005MV\u0002OUKJ"
    ...
    invoke-direct {v0, v13, v3, v4}, Lio/reactivex/internal/operators/parallel/ParallelFilterTry;-><init>(Lio/reactivex/parallel/ParallelFlowable;Lio/reactivex/functions/Predicate;Lio/reactivex/functions/BiFunction;)V
    ...
    invoke-direct {v0, v13, v4, v5}, Lio/reactivex/internal/operators/parallel/ParallelFilterTry;-><init>(Lio/reactivex/parallel/ParallelFlowable;Lio/reactivex/functions/Predicate;Lio/reactivex/functions/BiFunction;)V
    ...
    invoke-direct {v0, v13, v4}, Lio/reactivex/internal/operators/parallel/ParallelFilter;-><init>(Lio/reactivex/parallel/ParallelFlowable;Lio/reactivex/functions/Predicate;)V
    ...
    new-instance v12, Lio/reactivex/internal/operators/parallel/ParallelPeek;
    ...
    sget-object p1, Lio/reactivex/internal/functions/Functions;->EMPTY_LONG_CONSUMER:Lio/reactivex/functions/LongConsumer;
    ...
    invoke-direct/range {v12 .. v21}, Lio/reactivex/internal/operators/parallel/ParallelPeek;-><init>(Lio/reactivex/parallel/ParallelFlowable;Lio/reactivex/functions/Consumer;Lio/reactivex/functions/Consumer;Lio/reactivex/functions/Consumer;Lio/reactivex/functions/Action;Lio/reactivex/functions/Action;Lio/reactivex/functions/Consumer;Lio/reactivex/functions/LongConsumer;Lio/reactivex/functions/Action;)V
    ...
    check-cast v3, Lio/reactivex/functions/LongConsumer;

    const-string v6, "DD)=JO@OQ}HS\u0001PXPQ"
    ...
    invoke-direct {v0, v13, v4, v5}, Lio/reactivex/internal/operators/parallel/ParallelDoOnNextTry;-><init>(Lio/reactivex/parallel/ParallelFlowable;Lio/reactivex/functions/Consumer;Lio/reactivex/functions/BiFunction;)V
    ...
    const-string v2, "(6759\u0010*8/82@n9DqAIAB"
    ...
    sget-object v18, Lio/reactivex/internal/functions/Functions;->EMPTY_ACTION:Lio/reactivex/functions/Action;
    ...
    const-string v6, "UU)O^P^ASa]Z`ThZ\u0016`k\u0019hphi"
    ...
    invoke-static {v15, v1}, Lio/reactivex/internal/functions/ObjectHelper;->requireNonNull(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-virtual {v13, v2, v0, v1}, Lio/reactivex/parallel/ParallelFlowable;->concatMapDelayError(Lio/reactivex/functions/Function;IZ)Lio/reactivex/parallel/ParallelFlowable;
    ...
    :goto_22
    invoke-direct {v1, v13, v4, v3, v0}, Lio/reactivex/internal/operators/parallel/ParallelConcatMap;-><init>(Lio/reactivex/parallel/ParallelFlowable;Lio/reactivex/functions/Function;ILio/reactivex/internal/util/ErrorMode;)V
    ...
    const-string v3, "A4BA5Am6?j8>43"
    ...
    invoke-static {v7, v0}, Lio/reactivex/internal/functions/ObjectHelper;->verifyPositive(ILjava/lang/String;)I

    new-instance v1, Lio/reactivex/internal/operators/parallel/ParallelConcatMap;

    sget-object v0, Lio/reactivex/internal/util/ErrorMode;->IMMEDIATE:Lio/reactivex/internal/util/ErrorMode;

    invoke-direct {v1, v13, v6, v7, v0}, Lio/reactivex/internal/operators/parallel/ParallelConcatMap;-><init>(Lio/reactivex/parallel/ParallelFlowable;Lio/reactivex/functions/Function;ILio/reactivex/internal/util/ErrorMode;)V
    ...
    invoke-virtual {v13, v1, v0}, Lio/reactivex/parallel/ParallelFlowable;->concatMap(Lio/reactivex/functions/Function;I)Lio/reactivex/parallel/ParallelFlowable;
    ...
    check-cast v5, Lio/reactivex/parallel/ParallelTransformer;

    const-string v4, "5B=AEJ9Gi4;h<D89"
    ...
    invoke-interface {v0, v13}, Lio/reactivex/parallel/ParallelTransformer;->apply(Lio/reactivex/parallel/ParallelFlowable;)Lio/reactivex/parallel/ParallelFlowable;
    ...
    check-cast v4, Lio/reactivex/functions/BiConsumer;

    const-string v5, "TTE7$\u0016\\E=0\t`OC1\"st\u0016QO1snWK"
    ...
    const-string v2, "^8E_+eLBsO\u0015C\u001axi\u0005!"
    ...
    invoke-direct {v0, v13, v3, v4}, Lio/reactivex/internal/operators/parallel/ParallelCollect;-><init>(Lio/reactivex/parallel/ParallelFlowable;Ljava/util/concurrent/Callable;Lio/reactivex/functions/BiConsumer;)V
...
.method public final collect(Ljava/util/concurrent/Callable;Lio/reactivex/functions/BiConsumer;)Lio/reactivex/parallel/ParallelFlowable;
    ...
    invoke-direct {p0, v0, v1}, Lio/reactivex/parallel/ParallelFlowable;->᫗࡬ࡡ(I[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final concatMap(Lio/reactivex/functions/Function;I)Lio/reactivex/parallel/ParallelFlowable;
    ...
    invoke-direct {p0, v0, v2}, Lio/reactivex/parallel/ParallelFlowable;->᫗࡬ࡡ(I[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public abstract subscribe([Liz/᫞᫓࡭;)V
    .param p1    # [Liz/᫞᫓࡭;
        .annotation build Lio/reactivex/annotations/NonNull;
        .end annotation
    .end param
...
.method public final validate([Liz/᫞᫓࡭;)Z
    .locals 2
    .param p1    # [Liz/᫞᫓࡭;
        .annotation build Lio/reactivex/annotations/NonNull;
        .end annotation
...
.method public varargs ᫚ࡪࡨ(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p0, p1, p2}, Lio/reactivex/parallel/ParallelFlowable;->᫗࡬ࡡ(I[Ljava/lang/Object;)Ljava/lang/Object;
