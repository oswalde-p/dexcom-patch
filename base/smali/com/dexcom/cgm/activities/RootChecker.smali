.class public final Lcom/dexcom/cgm/activities/RootChecker;
...
.method public static checkRootMethod1()Z
    .locals 2
    ...
    invoke-static {v0, v1}, Lcom/dexcom/cgm/activities/RootChecker;->ᫌ᫆ࡨ(I[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static checkRootMethod2()Z
    .locals 2
...
.method public static checkRootMethod4(Ljava/lang/String;)Z
    .locals 2
...
.method public static doRootCheck()V
    .locals 2
...
.method public static varargs ᫌ᫆ࡨ(I[Ljava/lang/Object;)Ljava/lang/Object;
    .locals 20
    ...
    :pswitch_0
    invoke-static {}, Lcom/dexcom/cgm/activities/RootChecker;->checkRootMethod1()Z

    move-result v0

    if-nez v0, :cond_1

    invoke-static {}, Lcom/dexcom/cgm/activities/RootChecker;->checkRootMethod2()Z

    move-result v0

    if-nez v0, :cond_1

    invoke-static {}, Lcom/dexcom/cgm/activities/RootChecker;->checkRootMethod3()Z
    ...
    invoke-static {v1}, Lcom/dexcom/cgm/activities/RootChecker;->checkRootMethod4(Ljava/lang/String;)Z
    ...
    :pswitch_1
    invoke-static {}, Lcom/dexcom/cgm/activities/RootChecker;->isRooted()Z

    move-result v1

    if-eqz v1, :cond_25

    const-string v10, "-IHL\u001a>:7>"
    ...
    const-string v11, "cDR\u001a-\u007f@P\u001d\u0003<b\u0018W$nJ;;TR"
    ...
    invoke-static {v8, v2}, Liz/࡯ࡪ;->w(Ljava/lang/String;Ljava/lang/Object;)I
    ...
    const-string v6, "\u000f\u0007O@Tf\u0007yS[=W\u000bW[J8"
    ...
    const-string v3, "v<C>@2;}H3;A\u0003L>@;A"
    ...
    :pswitch_4
    const-string v4, "{AHCE7@\u00036FG\u0007,OKAOSRES\u0010DTP"
    ...
    const-string v3, " elgi[d\'q\\dj,qt"
    ...
    const-string v3, "\u001aPNbP\u001f]aVUa%Yag)nq"
    ...
    const-string v3, "~DKFH:C\u0006K=\tS>FL\u000eSV"
    ...
    const-string v4, "q \u0001]W#\u000e8V@.JtXC!!qQ9u\u0015\u0001"
