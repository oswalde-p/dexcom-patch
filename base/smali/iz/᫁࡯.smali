...
.method public constructor <init>(Ljava/time/Instant;Ljava/time/ZoneOffset;DLiz/ࡣ᫂;)V
    ...
    iput-object p1, p0, Liz/᫁࡯;->time:Ljava/time/Instant;

    iput-object p2, p0, Liz/᫁࡯;->zoneOffset:Ljava/time/ZoneOffset;

    iput-wide p3, p0, Liz/᫁࡯;->heartRateVariabilityMillis:D

    iput-object p5, p0, Liz/᫁࡯;->metadata:Liz/ࡣ᫂;
...
.method public synthetic constructor <init>(Ljava/time/Instant;Ljava/time/ZoneOffset;DLiz/ࡣ᫂;ILiz/᫁ࡤ࡭;)V
    ...
    :cond_0
    invoke-direct/range {p0 .. p5}, Liz/᫁࡯;-><init>(Ljava/time/Instant;Ljava/time/ZoneOffset;DLiz/ࡣ᫂;)V
...
.method private varargs ᫏᫛ࡡ(I[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :sswitch_0
    iget-wide v0, p0, Liz/᫁࡯;->heartRateVariabilityMillis:D
    ...
    invoke-virtual {p0}, Liz/᫁࡯;->getTime()Ljava/time/Instant;
    ...
    invoke-virtual {p0}, Liz/᫁࡯;->getZoneOffset()Ljava/time/ZoneOffset;
    ...
    invoke-virtual {p0}, Liz/᫁࡯;->getMetadata()Liz/ࡣ᫂;
    ...
    :sswitch_1
    iget-object v0, p0, Liz/᫁࡯;->metadata:Liz/ࡣ᫂;
    ...
    :cond_3
    iget-wide v3, p0, Liz/᫁࡯;->heartRateVariabilityMillis:D

    check-cast v6, Liz/᫁࡯;

    iget-wide v1, v6, Liz/᫁࡯;->heartRateVariabilityMillis:D
    ...
    invoke-virtual {v6}, Liz/᫁࡯;->getTime()Ljava/time/Instant;
    ...
    invoke-virtual {v6}, Liz/᫁࡯;->getZoneOffset()Ljava/time/ZoneOffset;
    ...
    invoke-virtual {v6}, Liz/᫁࡯;->getMetadata()Liz/ࡣ᫂;
...
.method public getTime()Ljava/time/Instant;
    ...
    iget-object p0, p0, Liz/᫁࡯;->time:Ljava/time/Instant;
...
.method public getZoneOffset()Ljava/time/ZoneOffset;
    ...
    iget-object p0, p0, Liz/᫁࡯;->zoneOffset:Ljava/time/ZoneOffset;
